...
export const createAct = (data, nameFile) => {
  ...
  const tab = {
    ...
    width: widthArea, // ширина таблицы
    heightHeader: 10, // высота заголовка таблицы
    heightSubtitle: 5, // высота подзаголовка : 'Услуги связи согласно...'
    heightLine: 8, // высота каждой строки с услугами
