...
example:
node ${nameProgramm} -p2021_12 -b  // get data from database (customers.csv & book.csv) for 2021_12 and saved in ./source/2021_12
node ${nameProgramm} -p2021_12 -b -ait // get data from database, saved in ./source/2021_12 and create Act, Invoice, Account
