...
export const createAccount = (data, nameFile) => {
  const op = {
    widthArea: 185, // ширина документа
    // top table - "Образец заполнения ...""
    tab: {
      height: 34, // высота
      cols: [110, 20, 55], // = 185, ширина колонок
      rows1: [14, 5, 15], // = 34, высота строк в 1-й колонке
      rows2: [7, 7, 20], // 34, высота строк во 2-й и 3-й колонке
    },
    // body table - "Товары (работы, услуги) .."
    tab2: {
      cols: [120, 12, 9, 20, 24], // = 185, ширина колонок
      labels: ['Товары (работы, услуги)', 'Кол-во', 'Ед.', 'Цена', 'Сумма'],
      hightRow: 5, // высота строк: 1-й и 2-й
